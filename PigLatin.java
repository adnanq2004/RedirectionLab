...
public class PigLatin{
	...
	public static String pigLatinSimple(String s) {
		...
		for (int i = 0; i < pain2.size(); i++) {
			if (s.substring(0,1).equals(pain2.get(i))) {
				improv += "hay";
				return improv;
			}
		}
		improv = s.substring(1,s.length());
		improv += s.substring(0,1);
		improv += "ay";
		return improv;
	}
	...
	public static String pigLatin(String s) {
		...
		if (s.length() > 2) {
			for (int i = 0; i < pain.size(); i++) {
				if (s.substring(0,2).equals(pain.get(i))) {
					improv = s.substring(2,s.length());
					improv += pain.get(i);
					improv += "ay";
					return improv;
				}
